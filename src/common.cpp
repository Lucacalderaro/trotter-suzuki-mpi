...
void ini_matrix_zero(size_t tile_width, size_t tile_height, double *real, double *imag) {
	for (size_t i; i < tile_height; i++) {
		for (size_t j; j < tile_width; j++) {
			real[i * tile_width + j] = 0;
			imag[i * tile_width + j] = 0;
		}
	}
}
